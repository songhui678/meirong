...
<body>
	...
	<header id="bjui-header" style="height:50px;">
        <div class="bjui-navbar-header">
            ...
            <a class="bjui-navbar-logo"  style="font-size:20px;color:#fff;line-height:45px;"><?php echo (C("WEB_SITE_TITLE")); ?><span style="font-size:12px"></span><!--<img src="/Public/images/logo.png">--></a>
        </div>
	...
	您好！<?php echo (get_shop_name(session('shopid'))); ?> <?php echo (session('depname')); ?> <?php echo (session('posname')); ?> <?php echo (session('truename')); ?> (<?php echo (session('username')); ?>) 您的IP:<?php echo (session('loginip')); ?>   登录时间:<?php echo (session('logintime')); ?>
